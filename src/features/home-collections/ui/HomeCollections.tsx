...
import { useGetAllCollectionsQuery } from '@/shared/api/rtkQuery'
import { CategoryList } from '@features/category-content/shared/ui/CategoryList'
import { Button } from '@shared/uikit'
import { useState } from 'react'
import { IoChevronForward } from 'react-icons/io5'
import { Link } from 'react-router-dom'
import { homeSliderPosters } from '../assets/home-posters'
...
export const HomeCollections = () => {
	...
	const handleLoadMoreItems = () =>
		setVisibleCount((prev) =>
			Math.min(prev + LOAD_MORE_COUNT, collectionEntries.length)
		)
